...
class SettingsViewController: UITableViewController {
	...
	@IBAction func didChangeSetting(_ sender: UISwitch) {
		...
		switch sender {
            ...
            case scaleWithPinchGestureSwitch:
                defaults.set(!sender.isOn, for: .noScaleWithPinchGesture)
	...
	private func populateSettings() {
		...
		scaleWithPinchGestureSwitch.isOn = !defaults.bool(for: .noScaleWithPinchGesture)
